                                            ...
                                            <td>
                                                @if ($item->transaction_status == 'PENDING')
                                                    <a href="{{ route('transactions.status', $item->id) }}? status=SUCCESS" 
                                                        class="btn btn-success btn-sm" title="success">
                                                        <i class="fa fa-check"></i>
                                                    </a>      
                                                    <a href="{{ route('transactions.status', $item->id) }}? status=FAILED" 
                                                        class="btn btn-danger btn-sm" title="failed">
                                                ...
                                                <a href="{{ route('transactions.edit', $item->id) }}" class="btn btn-primary btn-sm" title="Edit">
